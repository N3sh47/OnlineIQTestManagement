...
def admin_view_teacher_view(request):
    ...
    return render(request,'quiz/admin_view_company.html',{'teachers':teachers})
...
def admin_view_pending_teacher_view(request):
    ...
    return render(request,'quiz/admin_view_pending_company.html',{'teachers':teachers})
...
def admin_view_teacher_salary_view(request):
    teachers= TMODEL.Teacher.objects.all().filter(status=True)
    return render(request,'quiz/admin_view_company_salary.html',{'teachers':teachers})
...
def admin_student_view(request):
    ...
    return render(request,'quiz/admin_applicant.html',context=dict)

@login_required(login_url='adminlogin')
def admin_view_student_view(request):
    students= SMODEL.Student.objects.all()
    return render(request,'quiz/admin_view_applicant.html',{'students':students})
...
def update_student_view(request,pk):
    ...
    if request.method=='POST':
        ...
        if userForm.is_valid() and studentForm.is_valid():
            ...
            user.save()
            studentForm.save()
            return redirect('admin-view-applicant')
    return render(request,'quiz/update_applicant.html',context=mydict)
...
def delete_student_view(request,pk):
    ...
    user.delete()
    student.delete()
    return HttpResponseRedirect('/admin-view-applicant')


@login_required(login_url='adminlogin')
def admin_course_view(request):
    return render(request,'quiz/admin_field.html')
...
def admin_add_course_view(request):
    ...
    if request.method=='POST':
        ...
        if courseForm.is_valid():        
            ...
            print("form is invalid")
        return HttpResponseRedirect('/admin-view-field')
    return render(request,'quiz/admin_add_field.html',{'courseForm':courseForm})


@login_required(login_url='adminlogin')
def admin_view_course_view(request):
    courses = models.Course.objects.all()
    return render(request,'quiz/admin_view_field.html',{'courses':courses})
...
def admin_view_student_marks_view(request):
    students= SMODEL.Student.objects.all()
    return render(request,'quiz/admin_view_applicant_marks.html',{'students':students})
